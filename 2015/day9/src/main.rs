...
pub fn read_input(path: &str) -> InputType
{
    ...
    for l in input {
        ...
        res.push((words[0].to_string(), words[2].to_string(), words[4].parse().unwrap())) ;
    }
...
mod test 
{
    ...
    fn test1()
    {
        assert_eq!(result_1(read_input(TEST_INPUT_PATH)), 605);
    }
    ...
    fn test2()
    {
        assert_eq!(result_2(read_input(TEST_INPUT_PATH)), 982);
    }
}