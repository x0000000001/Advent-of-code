...
const iterate4 = (cubes) => {
    let new_state = new Set();
    const [minx, maxx, miny, maxy, minz, maxz, mink, maxk] = Array.from(cubes).reduce(([minx, maxx, miny, maxy, minz, maxz, mink, maxk], key) => {
