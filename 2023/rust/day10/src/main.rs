...
fn main() {
    ...
    let s_test = String::from(include_str!("../test_input1.txt"));
    exec_func(part1, s_test.clone(), "PART 1 TEST 1");
    let s = String::from(include_str!("../input.txt"));
    exec_func(part1, s.clone(), "PART 1");
    let s_test = String::from(include_str!("../test_input2.txt"));
    exec_func(part2, s_test.clone(), "PART 2 TEST");
    let s_test = String::from(include_str!("../test_input3.txt"));
    exec_func(part2, s_test.clone(), "PART 2 TEST");
    let s_test = String::from(include_str!("../test_input4.txt"));
    exec_func(part2, s_test.clone(), "PART 2 TEST");
