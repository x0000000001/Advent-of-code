...
fn read_input() -> (u64, u64)
{
    ...
    let foo = |l: &String| -> u64 {match l.chars().last().unwrap() {
        '0' => 10,
...
pub fn result_1() -> i64
{
    let (mut pawn0, mut pawn1) = read_input();
    ...
    looser_score as i64 * rolled_count as i64
}
...
fn calculate_occ(pawn0: u64, pawn1: u64, total0: u64, total1: u64, occ: &mut HashMap<(u64,u64,u64,u64), (u64,u64)>)
{
