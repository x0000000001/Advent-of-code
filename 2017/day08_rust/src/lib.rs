...
pub type InputType = Vec<(String,Operation,i64,Val,String,Val)>;
...
pub fn result_1(input: InputType) -> i64
{
    ...
    reg.into_iter().map(|(_,v)| v).max().unwrap()
}
...
mod test 
{
    ...
    fn test1()
    {
        assert_eq!(result_1(read_input(TEST_INPUT_PATH)), 1);
    }
