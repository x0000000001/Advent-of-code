...
pub fn result_1(regex: InputType) -> i64 {
    ...
    // println!("{:?}", regex);
    // println!("{:?}", count_possible_max_paths(&regex));
    // regex.furhest_room_distance() as i64
    map.furthest_room_distance() as i64
}
...
pub fn read_input(path: &str) -> InputType {
    ...
    let (result_1, result_2) = solve(line.clone());
    println!("solve : {} {}", result_1, result_2);
