...
pub type InputType = (usize, Position);
...
pub fn result_1((depth, target): InputType) -> i64 {
...
pub fn result_2((depth, target): InputType) -> i64 {
    ...
    djisktra(&t, target, &allowed_tools) as i64
}
