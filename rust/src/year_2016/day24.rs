...
type InputType = (Vec<Vec<Node>>, (usize, usize));
...
pub fn part1(s: String) -> Solution {
    ...
    Solution::from(modified_djikstra(start_id, &weights) as i64)
}
...
pub fn part2(s: String) -> Solution {
    ...
    Solution::from(modified_djikstra2(start_id, &weights) as i64)
}
