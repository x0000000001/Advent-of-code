...
impl Burrow {
    ...
    fn available_paths(&self) -> Vec<(i64, Burrow)> {
        let letters_costs: &HashMap<char, i64> =
            &HashMap::from([('A', 1), ('B', 10), ('C', 100), ('D', 1000)]);
        let rooms_by_letters: &HashMap<char, usize> =
...
pub fn part1(s: String) -> Solution {
    ...
    Solution::from(find_min_cost(&input, &mut HashMap::new()).unwrap())
}
