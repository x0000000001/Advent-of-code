...
pub type InputType = Vec<Component>;
...
pub fn result_1(components: InputType) -> i64 {
    strongest_bridge(0, components, &mut HashMap::new()) as i64
}
...
pub fn result_2(components: InputType) -> i64 {
    strongest_longest_bridge(0, components, &mut HashMap::new()).1 as i64
}
